...
export default function Nav() {
  ...
  return (
    <>
      ...
      <div className="fixed flex items-center justify-between gap-3 z-20 bg-bgColor/60 backdrop-blur-md top-0 left-0 right-0 py-4 px-5 md:px-10 text-primaryTextColor">
        ...
        <nav className="hidden md:flex justify-center flex-1">
          <ul className="flex items-center gap-4 lg:gap-6">
            {[
              { icon: TbHome2, name: "Home" },
              { icon: TbMovie, name: "Movies" },
              { icon: TbDeviceTv, name: "Series" },
      ...
      {/* ─── Mobile Bottom Tab Bar (Home / Series / Movies / Search) ─── */}
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-bgColor/95 backdrop-blur-md border-t border-secondaryTextColor/15 flex items-center justify-around h-16">
        <Link
          ...
          className={`flex flex-col items-center gap-1 w-16 transition-colors ${
            location.pathname === "/" ? "text-otherColor" : "text-secondaryTextColor"
          }`}
        >
        ...
        <Link
          to="/series"
          className={`flex flex-col items-center gap-1 w-16 transition-colors ${
            location.pathname === "/series" ? "text-otherColor" : "text-secondaryTextColor"
          }`}
        >
          <TbDeviceTv className="text-xl" />
          <span className="text-[10px] font-semibold">Series</span>
        </Link>
        <Link
          to="/movies"
          className={`flex flex-col items-center gap-1 w-16 transition-colors ${
            location.pathname === "/movies" ? "text-otherColor" : "text-secondaryTextColor"
          }`}
        >
        ...
        <button
          ...
          className="flex flex-col items-center gap-1 w-16 text-secondaryTextColor transition-colors"
        >
